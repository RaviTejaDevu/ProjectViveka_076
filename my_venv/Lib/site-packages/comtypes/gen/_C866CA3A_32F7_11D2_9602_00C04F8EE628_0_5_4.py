...
__all__ = [
    'DISPID_SPPConfidence', 'DISPID_SVGetAudioOutputs',
    'SAFT24kHz16BitMono', 'SpeechPropertyResourceUsage',
    'DISPID_SPIReplacements', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SPPValue', 'ISpSerializeState', 'SPINTERFERENCE_NOSIGNAL',
    'SGDSInactive', 'DISPID_SGRsFindRule', 'DISPIDSPRG',
    'SpeechTokenIdUserLexicon', 'SSSPTRelativeToCurrentPosition',
    'SRERequestUI', 'DISPID_SPPsItem', 'SPEI_SENTENCE_BOUNDARY',
    'SpeechStreamFileMode', 'SVESentenceBoundary',
    'DISPID_SRGCmdLoadFromFile', 'SP_VISEME_6',
    'Speech_Max_Word_Length', 'SP_VISEME_0', 'SVEAllEvents',
    'ISpeechGrammarRules', 'DISPID_SGRSTNextState',
    'SpeechEngineProperties', 'DISPID_SGRAddState', 'ISpPhraseAlt',
    'ISpeechGrammarRuleStateTransition', 'SRSInactive',
    'DISPID_SRCSetAdaptationData', 'DISPID_SPPId', 'SPSSuppressWord',
    'DISPID_SPPs_NewEnum', 'SPPROPERTYINFO', 'SpeechTokenKeyUI',
    '_ISpeechVoiceEvents', 'DISPID_SGRSAddRuleTransition',
    'SPINTERFERENCE_TOOLOUD', 'ISpObjectTokenCategory',
    'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPAUDIOSTATUS',
    'ISpeechObjectTokens', 'DISPID_SPAsCount', 'SRSEDone',
    'DISPID_SPIAudioSizeTime', 'DISPID_SDKEnumValues',
    'SpeechAllElements', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SpeechPhraseReplacements', 'SpStream',
    'DISPID_SRCERecognitionForOtherContext', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SpeechVoiceEvent', 'ISpResourceManager',
    'DISPID_SRRTStreamTime', 'DISPID_SPRuleFirstElement',
    'SVSFNLPMask', 'DISPID_SPCIdToPhone',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SDA_No_Trailing_Space', 'SpCompressedLexicon',
    'DISPID_SVGetAudioInputs', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRRPhraseInfo', 'SPEI_RESERVED6',
    'SpeechPropertyAdaptationOn', 'SREPropertyNumChange',
    'eLEXTYPE_PRIVATE13', 'DISPID_SAEventHandle',
    'SPEI_END_INPUT_STREAM', 'SAFT16kHz16BitStereo',
    'DISPID_SLGetWords', 'DISPID_SGRSTPropertyName',
    'SRAORetainAudio', 'SP_VISEME_1', 'SpeechTokenKeyAttributes',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPFM_OPEN_READWRITE',
    'SP_VISEME_7', 'SSFMCreateForWrite',
    'DISPID_SPEAudioStreamOffset', 'SPAR_Unknown', 'SPSHT_Unknown',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SGRsCommit',
    'SAFT12kHz8BitStereo', 'SPPS_RESERVED4',
    'SGDSActiveUserDelimited', 'DISPID_SLPs_NewEnum',
    'SAFT8kHz8BitStereo', 'SpeechPartOfSpeech',
    'SWPUnknownWordPronounceable',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRGDictationLoad',
    'SPEI_INTERFERENCE', 'SAFT24kHz8BitMono', 'DISPID_SBSWrite',
    'DISPID_SASNonBlockingIO', 'DISPID_SDKDeleteValue', 'SREPrivate',
    'DISPID_SRCEventInterests', 'DISPID_SPRNumberOfElements',
    'SPBO_PAUSE', 'DISPID_SRCCmdMaxAlternates', 'SVP_15',
    'SPFM_CREATE_ALWAYS', 'DISPID_SVPause', 'DISPID_SCSBaseStream',
    'SAFT11kHz16BitStereo', 'DISPID_SWFEBlockAlign', 'SGSEnabled',
    'ISpeechWaveFormatEx', 'DISPID_SGRClear',
    'ISpStreamFormatConverter', 'DISPID_SRIsShared', 'SPEI_RESERVED5',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SPIEnginePrivateData',
    'DISPID_SOTCategory', 'eLEXTYPE_PRIVATE20', 'eLEXTYPE_RESERVED8',
    'DISPID_SPRuleChildren', 'SpFileStream',
    'DISPID_SpeechRecoResultTimes', 'SAFT48kHz8BitStereo',
    'SPSUnknown', 'DISPID_SABIBufferSize', 'eWORDTYPE_ADDED',
    'SVEBookmark', 'DISPID_SVIsUISupported', 'SVP_3',
    'DISPID_SRCEStartStream', 'SPRECOCONTEXTSTATUS', 'SPCONTEXTSTATE',
    'DISPID_SVSInputWordPosition', 'SRTAutopause', 'SPAS_STOP',
    'DISPID_SPPEngineConfidence', 'SVEStartInputStream',
    'DISPID_SpeechLexiconWord',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPPFirstElement',
    'DISPID_SRRSaveToMemory', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SPPNumberOfElements', 'DISPID_SPERetainedStreamOffset',
    'SpeechPropertyHighConfidenceThreshold', 'SAFT32kHz8BitStereo',
    'DISPID_SGRs_NewEnum', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SVGetProfiles', 'SpeechVisemeFeature', 'SREStateChange',
    'SP_VISEME_3', 'DISPID_SVVolume', 'SVSFVoiceMask',
    'SRESoundStart', 'SPSLMA', 'SECFDefault', 'SpeechRuleAttributes',
    'SLTApp', 'DISPID_SpeechBaseStream', 'SVP_18',
    'ISpeechFileStream', 'DISPID_SGRSTs_NewEnum', 'SPEI_REQUEST_UI',
    'DISPID_SpeechPhraseReplacement', 'SITooLoud',
    'SAFT12kHz16BitStereo', 'DISPID_SOTCSetId',
    'SAFTCCITT_ALaw_22kHzStereo', 'SVP_16', 'ISpeechLexicon',
    'SPVPRI_NORMAL', 'DISPID_SRSetPropertyNumber', 'DISPID_SLWsCount',
    'ISpeechAudioStatus', 'DISPID_SPEEngineConfidence',
    'SpeechGrammarWordType', 'SPFM_OPEN_READONLY', 'SPEVENT',
    'SITooQuiet', 'SPLO_DYNAMIC', 'DISPID_SRCESoundEnd',
    'SPVOICESTATUS', 'DISPID_SPIAudioStreamPosition',
    'SRERecoOtherContext', 'SVF_Emphasis', 'SSTTDictation',
    'SpeechAddRemoveWord', 'SpShortcut', 'SVP_6', 'DISPID_SPCLangId',
    'SVEPrivate', 'DISPID_SDKDeleteKey', 'SREHypothesis',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SGRSTRule',
    'DISPID_SLWWord', 'DISPID_SVVoice', 'DISPID_SOTRemove',
    'SPEVENTENUM', 'SP_VISEME_13', 'DISPID_SPRulesCount',
    'eLEXTYPE_APP', 'DISPID_SRCESoundStart',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SVEWord',
    'SpResourceManager', 'DISPID_SPELexicalForm', 'SVEPhoneme',
    'SINoise', 'SPSInterjection', 'DISPID_SGRId',
    'SECFIgnoreKanaType', 'SVF_Stressed', 'DISPID_SRCEHypothesis',
    'ISpeechRecoResultTimes', 'SASClosed',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SRRAudio',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SpeechPhraseProperties',
    'SpCustomStream', 'ISpEventSource', 'DISPID_SRRAudioFormat',
    'SAFT22kHz8BitStereo', 'SPRS_INACTIVE', 'eLEXTYPE_RESERVED9',
    'DISPID_SPEDisplayText', 'SAFTGSM610_8kHzMono', 'SPEI_RESERVED1',
    'SREStreamEnd', 'DISPID_SpeechPhraseAlternates', 'SRCS_Enabled',
    'SPPS_Modifier', 'SPEI_FALSE_RECOGNITION', 'SGRSTTRule',
    'SPWORDPRONOUNCEABLE', 'SPINTERFERENCE_NOISE', 'DISPID_SRGState',
    'DISPID_SVSPhonemeId', 'ISpeechLexiconWords',
    'SPEI_WORD_BOUNDARY', 'SpeechGrammarState', 'ISpNotifySource',
    'SpeechFormatType', 'SPEI_VOICE_CHANGE',
    'SpeechGrammarTagDictation', 'IStream', 'SRSInactiveWithPurge',
    'SPCT_DICTATION', 'DISPID_SOTDataKey', 'SPSMF_SAPI_PROPERTIES',
    'SPINTERFERENCE_NONE', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SOTDisplayUI', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRGIsPronounceable', 'eLEXTYPE_PRIVATE19',
    'tagSPTEXTSELECTIONINFO', 'SP_VISEME_19', 'DISPID_SRRecognizer',
    'DISPID_SRCEBookmark', 'SAFT8kHz16BitStereo', 'SPFM_CREATE',
    'DISPID_SREmulateRecognition', 'DISPID_SLWsItem',
    'DISPID_SVESentenceBoundary', 'DISPID_SRCRequestedUIType',
    'SpeechRunState', 'SVP_5', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SpeechGrammarRule', 'DISPIDSPTSI_ActiveLength',
    'SECNormalConfidence', 'SVEAudioLevel', 'eLEXTYPE_LETTERTOSOUND',
    'SAFTADPCM_8kHzStereo', 'SREPropertyStringChange',
    'SAFTNonStandardFormat', 'SPWT_DISPLAY', 'SGRSTTDictation',
    'DISPID_SpeechPhraseAlternate', 'SpAudioFormat',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SFSOpen', 'SECLowConfidence',
    'DISPID_SLWs_NewEnum', 'SpeechAudioFormatGUIDText',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPRulesItem',
    'SpObjectTokenCategory', 'SAFT8kHz16BitMono',
    'SpeechCategoryRecoProfiles', 'SECFEmulateResult',
    'SpTextSelectionInformation', 'DISPID_SVSInputWordLength',
    'ISpeechCustomStream', 'SPEI_SR_AUDIO_LEVEL',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRIsUISupported',
    'DISPID_SVEVoiceChange', 'SVP_17', 'SPPS_SuppressWord',
    'ISequentialStream', 'SPEI_UNDEFINED', 'SpeechAudioState',
    'DISPID_SLPsCount', 'SPSHT_NotOverriden', 'DISPID_SPPsCount',
    'SPXRO_SML', 'SAFTCCITT_uLaw_44kHzMono', 'eLEXTYPE_VENDORLEXICON',
    'SPRULE', 'SVEViseme', 'SpeechSpecialTransitionType',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SpeechPhraseBuilder',
    'SpeechRecognizerState', 'DISPID_SpeechXMLRecoResult',
    'SPWORDTYPE', 'SPSERIALIZEDPHRASE', 'SAFTCCITT_uLaw_11kHzStereo',
    'Speech_Default_Weight', 'DISPID_SRStatus', 'ISpeechPhraseInfo',
    'SDTReplacement', 'SAFTADPCM_22kHzMono', 'ISpObjectWithToken',
    'SVP_2', '_SPAUDIOSTATE', 'SPAS_RUN', 'ISpPhoneConverter',
    'DISPID_SpeechRecoResult2', 'SPSERIALIZEDRESULT', 'SVP_7',
    'SPSEMANTICERRORINFO', 'eLEXTYPE_PRIVATE8', 'SRCS_Disabled',
    'ISpeechMemoryStream', 'SpMemoryStream', 'DISPID_SPRFirstElement',
    'SITooSlow', 'SPPHRASEREPLACEMENT', 'DISPID_SPEs_NewEnum',
    'SpeechCategoryAppLexicons', 'SPSEMANTICFORMAT',
    'DISPID_SRRTTickCount', 'eLEXTYPE_RESERVED10', 'ISpMMSysAudio',
    '_ISpeechRecoContextEvents', 'DISPID_SRCRetainedAudio',
    'SpeechWordType', 'DISPID_SPEsItem',
    'SpeechVoiceSkipTypeSentence', 'SAFT44kHz16BitStereo',
    'DISPID_SRGCommit', 'DISPID_SpeechObjectTokens',
    'DISPID_SPAs_NewEnum', 'DISPID_SVSLastResult',
    'ISpeechObjectToken', 'DISPID_SVEViseme', 'SPGS_ENABLED',
    'DISPID_SPRsItem', 'ISpLexicon', 'SPPS_RESERVED1',
    'SpStreamFormatConverter', 'SPVPRI_OVER',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRGRecoContext',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRGetRecognizers',
    'DISPID_SASCurrentSeekPosition', 'SRTEmulated', 'SpWaveFormatEx',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SGRSTransitions',
    'DISPID_SPRText', 'SPSHT_EMAIL', 'ISpeechAudio',
    'eLEXTYPE_PRIVATE9', 'SPSNoun', 'SPPS_Noun',
    'DISPID_SRCEEnginePrivate', 'SAFTNoAssignedFormat',
    'DISPID_SDKSetStringValue', 'DISPID_SRGReset',
    'SAFT12kHz8BitMono', 'SECFNoSpecialChars', 'SVSFParseAutodetect',
    'DISPID_SPRuleId', 'SPPS_NotOverriden', 'eLEXTYPE_PRIVATE17',
    'DISPID_SVEAudioLevel', 'SVSFIsFilename', 'SPEI_RECOGNITION',
    'IEnumSpObjectTokens', 'DISPID_SPIGetDisplayAttributes',
    'SREAllEvents', 'SVPNormal',
    'SpeechGrammarRuleStateTransitionType',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpeechBaseStream',
    'DISPID_SLWPronunciations', 'SpInProcRecoContext',
    'SPBO_TIME_UNITS', 'DISPID_SRSClsidEngine',
    'DISPID_SLGetGenerationChange', 'SpeechAudioProperties',
    'STCLocalServer', 'SPPARTOFSPEECH', 'DISPID_SABIMinNotification',
    'SpeechVoiceSpeakFlags', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SPPName', 'ISpeechLexiconPronunciations',
    'SpPhraseInfoBuilder', 'DISPID_SVSRunningState', 'SpLexicon',
    'DISPID_SRSAudioStatus', 'SPLEXICONTYPE',
    'DISPID_SOTGetDescription', 'SpeechInterference',
    'STSF_LocalAppData', 'SPPS_Interjection', 'DISPID_SLPsItem',
    'DISPID_SRCEInterference', 'DISPID_SPCPhoneToId',
    'DISPID_SLGetPronunciations', 'STCInprocHandler',
    'DISPID_SpeechVoiceStatus', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SDKSetBinaryValue', 'ISpeechPhraseReplacements',
    'SP_VISEME_12', 'SpeechVoicePriority', 'DISPID_SDKCreateKey',
    'eLEXTYPE_PRIVATE18', 'SVP_11', 'SPSHORTCUTPAIR',
    'eLEXTYPE_RESERVED7', 'SPEI_PHRASE_START', 'SPPHRASERULE',
    'SP_VISEME_15', 'SPPHRASE', 'DISPID_SOTsItem',
    'DISPID_SRRGetXMLErrorInfo', 'SPVPRI_ALERT', 'DISPID_SMSALineId',
    'SPEI_SOUND_START', 'DISPID_SRCBookmark', 'DISPID_SGRsItem',
    'SINone', 'DISPID_SPIAudioSizeBytes', 'DISPID_SGRSTText',
    'SPEI_RESERVED2', 'SpeechAudioVolume', 'DISPID_SRRTimes',
    'SRTExtendableParse', 'DISPID_SWFESamplesPerSec',
    'DISPID_SpeechFileStream', 'ISpeechPhraseInfoBuilder',
    'SPEI_MIN_TTS', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRGCmdSetRuleIdState', '_RemotableHandle',
    'DISPID_SMSAMMHandle', 'DISPID_SpeechRecoContext',
    'SPDATAKEYLOCATION', 'DISPID_SPANumberOfElementsInResult',
    'ISpRecoContext2', 'DISPID_SPRs_NewEnum',
    'DISPID_SRCEFalseRecognition', 'SPCS_DISABLED', 'STCInprocServer',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRCERecognition',
    'ISpeechPhraseAlternates', 'SVP_12', 'ISpeechPhraseAlternate',
    'SWPKnownWordPronounceable', 'SGSExclusive',
    'SpeechCategoryVoices', 'DISPID_SRGetPropertyNumber',
    'SPRST_NUM_STATES', 'SPRECORESULTTIMES', 'ISpeechPhraseProperty',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPRULESTATE', 'DISPIDSPTSI',
    'DISPID_SRRRecoContext', 'SVSFPurgeBeforeSpeak',
    'DISPID_SGRSTPropertyId', 'SAFT48kHz8BitMono',
    'DISPID_SpeechLexiconPronunciation', 'SPEI_RESERVED3',
    'DISPID_SADefaultFormat', 'DISPID_SRGRules', 'DISPID_SOTsCount',
    'SpeechUserTraining', 'Speech_StreamPos_RealTime',
    'DISPID_SAFGuid', 'eLEXTYPE_PRIVATE5', 'ISpDataKey',
    'SpMMAudioIn', 'SPXMLRESULTOPTIONS', 'DISPID_SRCreateRecoContext',
    'DISPID_SRCState', 'DISPID_SRSNumberOfActiveRules',
    'SPEI_MAX_TTS', 'Speech_StreamPos_Asap', 'SPPS_RESERVED3',
    'SPSHORTCUTTYPE', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPAR_Medium', 'SDKLCurrentConfig', 'SRAImport',
    'DISPID_SpeechLexiconWords', 'SVPOver',
    'DISPID_SRGCmdSetRuleState', 'SPVISEMES', 'SPINTERFERENCE',
    'DISPID_SLPSymbolic', 'ISpeechPhraseElements', 'SPBINARYGRAMMAR',
    'STSF_AppData', 'SPDKL_CurrentConfig', 'DISPID_SVEPhoneme',
    'SVP_19', 'DISPID_SRCEPhraseStart', 'DISPID_SPRuleConfidence',
    'SSFMCreate', 'DISPID_SpeechRecognizer',
    'DISPID_SPIRetainedSizeBytes', 'SPEI_RECO_STATE_CHANGE',
    'SRAExport', 'DISPID_SpeechVoice', 'SRTStandard',
    'SAFTADPCM_11kHzStereo', 'SAFT22kHz16BitMono',
    'SpeechLexiconType', 'SSSPTRelativeToEnd', 'ISpObjectToken',
    'ISpEventSink', 'SREFalseRecognition', 'SP_VISEME_20',
    'DISPID_SOTMatchesAttributes', 'SVEVoiceChange',
    'DISPID_SVSpeakStream', 'ISpPhoneticAlphabetSelection',
    'SpeechPropertyNormalConfidenceThreshold',
    'SpeechStreamSeekPositionType', 'SRERecognition',
    'SpPhoneticAlphabetConverter', 'SpeechDiscardType',
    'DISPID_SPIStartTime', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SVGetVoices', 'ISpeechRecoResult2',
    'DISPID_SpeechRecoContextEvents',
    'DISPID_SPAStartElementInResult', 'SRAInterpreter',
    'DISPID_SPISaveToMemory', 'DISPID_SRGSetTextSelection',
    'DISPID_SVEventInterests', 'SASPause', 'SVSFParseMask',
    'ISpeechRecoResult', 'SpPhoneConverter', 'SGSDisabled',
    'SpeechVoiceEvents', 'DISPID_SRCRecognizer',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SPRuleParent',
    'DISPID_SMSGetData', 'SPBO_NONE', 'DISPID_SRProfile',
    'SpeechWordPronounceable', 'DISPID_SGRsCount',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SBSRead',
    'DISPID_SVSLastBookmark', 'SPEI_SR_PRIVATE',
    'DISPID_SpeechPhoneConverter', 'SpeechCategoryAudioOut',
    'SPGRAMMARSTATE', 'SPSHT_OTHER', 'SpNullPhoneConverter',
    'DISPID_SPEActualConfidence', 'SREPhraseStart', 'ISpRecoContext',
    'SP_VISEME_10', 'SFTInput', 'DISPID_SPRDisplayAttributes',
    'DISPID_SRGId', 'SAFT8kHz8BitMono', 'UINT_PTR',
    'ISpeechAudioBufferInfo', 'DISPID_SMSADeviceId', 'SVSFDefault',
    'DISPID_SDKSetLongValue', 'SPLO_STATIC', 'ISpRecoGrammar2',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SAVolume', 'LONG_PTR', 'SpeechDataKeyLocation',
    'eLEXTYPE_PRIVATE12', 'ISpStreamFormat',
    'DISPID_SVSInputSentencePosition', 'SPPS_RESERVED2',
    'SSTTTextBuffer', 'SAFT48kHz16BitStereo', 'DISPID_SRCERequestUI',
    'DISPID_SPRuleName', 'ISpeechLexiconPronunciation',
    'SpeechRecoProfileProperties', 'SDTLexicalForm', 'ISpRecoGrammar',
    'SPEI_START_INPUT_STREAM', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRRGetXMLResult', 'DISPID_SWFEExtraData', 'SRAONone',
    'SVSFUnusedFlags', 'SREStreamStart', 'SAFT22kHz16BitStereo',
    'DISPID_SOTIsUISupported', 'DISPID_SRGetPropertyString', 'SVP_14',
    'DISPID_SOTs_NewEnum', 'DISPID_SPERequiredConfidence',
    'SPCATEGORYTYPE', 'SpMMAudioOut', 'SpSharedRecoContext',
    'eLEXTYPE_PRIVATE4', 'SP_VISEME_18', 'SPSHORTCUTPAIRLIST',
    'DISPID_SVEStreamEnd', 'ISpeechMMSysAudio', 'SITooFast',
    'SVSFlagsAsync', 'SpeechRetainedAudioOptions', 'SP_VISEME_16',
    'SDKLLocalMachine', 'SpeechVisemeType',
    'DISPID_SWFEBitsPerSample', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SGRAddResource', 'DISPID_SVSyncronousSpeakTimeout',
    'SpUnCompressedLexicon', 'DISPID_SpeechLexiconProns',
    'DISPID_SAStatus', 'SP_VISEME_17', 'SPVPRIORITY', 'SPFILEMODE',
    'SLTUser', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SRGCmdLoadFromMemory', 'SWTAdded',
    'DISPID_SGRInitialState', 'SAFT22kHz8BitMono',
    'SDA_One_Trailing_Space', 'ISpStream', 'ISpeechPhraseElement',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SVSVisemeId',
    'DISPID_SDKEnumKeys', 'ISpNotifySink', 'SPSVerb',
    'eLEXTYPE_PRIVATE11', 'SGDSActiveWithAutoPause',
    'ISpeechTextSelectionInformation', 'SpeechCategoryRecognizers',
    'SP_VISEME_9', 'DISPID_SOTCId', 'SAFT32kHz16BitMono',
    'SAFTADPCM_44kHzMono', 'SECFIgnoreWidth', 'DISPID_SRCPause',
    'SPEI_PHONEME', 'SBOPause', 'ISpPhoneticAlphabetConverter',
    'SVEWordBoundary', 'ISpRecoResult', 'eLEXTYPE_RESERVED4',
    'ISpeechPhraseReplacement', 'DISPID_SpeechAudioStatus',
    'DISPID_SGRName', 'ISpRecognizer3', 'ISpeechPhraseRules',
    'SPEI_MAX_SR', 'eLEXTYPE_PRIVATE16', 'DISPID_SRCEAdaptation',
    'SPAUDIOSTATE', 'SpeechMicTraining', 'SPCT_SUB_DICTATION',
    'SpeechCategoryPhoneConverters', 'SDKLCurrentUser',
    'SPRST_ACTIVE', 'DISPID_SLPLangId', 'DISPID_SRSetPropertyString',
    'ISpeechRecoContext', 'DISPID_SMSSetData', 'DISPID_SPPChildren',
    'DISPID_SVSLastBookmarkId', 'ISpeechAudioFormat',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFT24kHz8BitStereo', 'SGDisplay',
    'ISpXMLRecoResult', 'ISpeechRecognizer', 'SPAUDIOOPTIONS',
    'SPWORDPRONUNCIATION', 'SAFTGSM610_11kHzMono',
    'SDA_Two_Trailing_Spaces', 'SpNotifyTranslator',
    'SDA_Consume_Leading_Spaces', 'DISPID_SLWLangId',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpeechDisplayAttributes',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPPHRASEPROPERTY',
    'ISpeechGrammarRuleState', 'ISpeechGrammarRule', 'SpObjectToken',
    'SPEI_MIN_SR', 'SPEI_HYPOTHESIS', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SPEsCount', 'DISPID_SpeechPhraseInfo', 'SPPS_Noncontent',
    'DISPID_SVDisplayUI', 'SPGS_DISABLED', 'SPEI_END_SR_STREAM',
    'SAFTCCITT_ALaw_22kHzMono', 'SGRSTTEpsilon',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPIRule',
    'SAFT32kHz16BitStereo', 'SPEI_START_SR_STREAM',
    'SSSPTRelativeToStart', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SpeechRecognizerStatus', 'SPPS_Verb',
    'SAFT16kHz8BitStereo', 'DISPID_SRRSpeakAudio',
    'SAFT16kHz16BitMono', 'SP_VISEME_11', 'SGLexical',
    'SPGS_EXCLUSIVE', 'SRSEIsSpeaking',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SASCurrentDevicePosition', 'ISpRecognizer2',
    'DISPID_SLWType', 'DISPID_SVSkip', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFT24kHz16BitStereo', 'DISPID_SPAPhraseInfo', 'SECFIgnoreCase',
    'SVP_8', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SVAlertBoundary', 'SAFTGSM610_44kHzMono',
    'DISPID_SLPPhoneIds', 'SDKLDefaultLocation', 'SGDSActive',
    'ISpeechLexiconWord', 'SAFTGSM610_22kHzMono',
    'DISPID_SVWaitUntilDone', 'ISpAudio', 'SpeechRegistryUserRoot',
    'SREBookmark', 'SVSFNLPSpeakPunc', 'eLEXTYPE_PRIVATE15',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPEPronunciation',
    'SPWORDLIST', 'ISpRecognizer', 'DISPID_SASFreeBufferSpace',
    'DISPID_SLPPartOfSpeech', 'DISPID_SpeechAudioFormat',
    'IInternetSecurityMgrSite', 'ISpeechXMLRecoResult', 'SAFTText',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRSCurrentStreamNumber',
    'SPEI_ADAPTATION', 'SASStop',
    'ISpeechGrammarRuleStateTransitions',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SLRemovePronunciation',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRGDictationSetState',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SVRate', 'DISPID_SVAudioOutputStream', 'SVSFIsXML',
    'DISPID_SRAudioInput', 'SPTEXTSELECTIONINFO',
    'SpSharedRecognizer', 'SBONone', 'DISPID_SVSInputSentenceLength',
    'SPCT_SLEEP', 'SVSFIsNotXML', 'SRESoundEnd', 'DISPID_SVResume',
    'SPRS_ACTIVE', 'DISPID_SVAudioOutput', 'DISPID_SGRSTsCount',
    'SP_VISEME_5', 'SWTDeleted', 'SPAS_PAUSE', 'SPPS_Function',
    'eLEXTYPE_PRIVATE2', 'DISPID_SOTSetId',
    'ISpeechRecoResultDispatch', 'SpeechRecognitionType',
    'tagSTATSTG', 'DISPID_SPILanguageId', 'SVSFParseSsml',
    'SDTProperty', 'SAFTExtendedAudioFormat', 'SVP_0',
    'DISPID_SASetState', 'SSFMOpenReadWrite', 'SP_VISEME_2',
    'DISPID_SRCEEndStream', 'ISpRecoCategory', 'SRADynamic',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SpeechPhraseElement', 'DISPID_SASState',
    'SPDKL_LocalMachine', 'SDTPronunciation',
    'DISPID_SOTGetStorageFileName', 'SAFT44kHz8BitMono',
    'DISPID_SpeechCustomStream', 'ISpeechPhraseRule',
    'DISPIDSPTSI_SelectionLength', 'SVP_13', 'DISPID_SPACommit',
    'SGRSTTWord', 'SAFTADPCM_44kHzStereo', 'SREAdaptation',
    'SDTDisplayText', '__MIDL_IWinTypes_0009',
    'DISPID_SPEAudioSizeBytes', 'SpMMAudioEnum', 'SRSActive',
    'DISPID_SAFType', 'SPSModifier', 'SAFT48kHz16BitMono',
    'DISPID_SWFEChannels', 'SFTSREngine', 'SPAO_RETAIN_AUDIO',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SRRDiscardResultInfo', 'ISpGrammarBuilder',
    'SAFT16kHz8BitMono', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SpeechDataKey', 'eLEXTYPE_PRIVATE3', 'WAVEFORMATEX',
    'tagSPPROPERTYINFO', 'DISPID_SRState', 'DISPID_SpeechLexicon',
    'SAFTADPCM_8kHzMono', 'DISPID_SpeechObjectToken', 'ISpShortcut',
    'SpeechTokenContext', 'DISPID_SDKGetBinaryValue',
    'SPDKL_CurrentUser', 'DISPID_SGRAttributes', 'ISpProperties',
    'SPAR_High', 'SREAudioLevel', 'ISpNotifyTranslator',
    'SPLOADOPTIONS', 'SVP_1', 'SPCT_SUB_COMMAND', 'DISPID_SGRsAdd',
    'DISPID_SpeechRecoResult', 'DISPID_SVStatus', 'DISPID_SVPriority',
    'DISPID_SVSpeak', 'SPCT_COMMAND', 'DISPID_SLGenerationId',
    'DISPID_SDKOpenKey', 'SGRSTTTextBuffer', 'SPXRO_Alternates_SML',
    'ISpeechObjectTokenCategory', 'DISPID_SPIProperties',
    'DISPID_SGRSTsItem', 'ISpeechPhoneConverter',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPRECOSTATE',
    'SPBO_AHEAD', 'DISPID_SDKGetlongValue', 'SPWAVEFORMATTYPE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SPRsCount',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SOTId',
    'SGRSTTWildcard', 'ISpeechResourceLoader', 'DISPID_SpeechAudio',
    'DISPID_SpeechMMSysAudio', 'DISPID_SpeechPhraseElements',
    'eWORDTYPE_DELETED', 'SPWT_PRONUNCIATION', 'SpeechRecoEvents',
    'SLOStatic', 'SPWORDPRONUNCIATIONLIST', 'SPEI_TTS_PRIVATE',
    'DISPID_SVSCurrentStreamNumber', 'SpInprocRecognizer',
    'IEnumString', 'SP_VISEME_4', 'SP_VISEME_21',
    'DISPID_SLAddPronunciation', 'SPAR_Low', 'eLEXTYPE_PRIVATE6',
    'DISPID_SABufferNotifySize', 'SVPAlert', 'STCAll',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPIGetText', 'SPPS_Unknown',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SPRules_NewEnum',
    'ISpeechRecoGrammar', 'SINoSignal', 'SVP_20',
    'eLEXTYPE_PRIVATE10', 'DISPID_SLPType', 'DISPID_SBSFormat',
    'SPPHRASEELEMENT', 'SpeechAudioFormatGUIDWave', 'SRSActiveAlways',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRSTPropertyValue',
    'SPEI_RECO_OTHER_CONTEXT', 'SP_VISEME_8', 'SAFT44kHz8BitStereo',
    'DISPID_SPAsItem', 'SVP_10', 'DISPID_SRRSetTextFeedback',
    'SPEVENTSOURCEINFO', 'SpeechPropertyResponseSpeed',
    'SDTAlternates', 'SPFM_NUM_MODES', 'DISPID_SpeechPhraseRules',
    'DISPID_SRAudioInputStream', 'SVP_9', 'DISPID_SDKGetStringValue',
    'DISPID_SRCEAudioLevel', 'DISPID_SRGetFormat', 'SREInterference',
    'SGPronounciation', 'SPSTREAMFORMATTYPE', 'DISPID_SPARecoResult',
    'Speech_Max_Pron_Length', 'DISPID_SBSSeek',
    'SAFTCCITT_ALaw_11kHzMono', 'SPSFunction',
    'SpeechAudioFormatType', 'DISPID_SWFEFormatTag',
    'SpeechLoadOption', 'SDTRule', 'SPSMF_UPS', 'SVSFParseSapi',
    'SPGRAMMARWORDTYPE', 'DISPID_SRRTLength',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPBOOKMARKOPTIONS',
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_PRIVATE1', 'SpeechRuleState',
    'DISPID_SRSCurrentStreamPosition', 'SRTReSent',
    'DISPID_SRRAlternates', 'DISPID_SGRsDynamic', 'SRTSMLTimeout',
    'eLEXTYPE_USER', 'SECHighConfidence', 'SPAS_CLOSED',
    'STSF_CommonAppData', 'DISPID_SGRSTWeight', 'DISPID_SPIEngineId',
    'DISPID_SPPParent', 'ISpPhrase', 'ISpeechDataKey',
    'SpeechGrammarTagWildcard', 'DISPID_SRCEPropertyNumberChange',
    'SAFT12kHz16BitMono', 'SP_VISEME_14', 'SSFMOpenForRead', 'SVP_21',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFT44kHz16BitMono',
    'SAFTADPCM_22kHzStereo', 'SDTAll', 'SRATopLevel',
    'DISPID_SRCResume', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPWT_LEXICAL',
    'DISPID_SOTCDefault', 'STCRemoteServer', 'SpeechCategoryAudioIn',
    'SPRST_INACTIVE', 'SRADefaultToActive', 'DISPID_SVEBookmark',
    'SAFT32kHz8BitMono', 'SpeechEmulationCompareFlags',
    'DISPID_SRCCreateGrammar', 'SpeechBookmarkOptions',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SABIEventBias', 'SPEI_VISEME',
    'DISPID_SVEEnginePrivate', 'DISPID_SRGDictationUnload',
    'DISPID_SOTCreateInstance', 'DISPID_SVEStreamStart', 'SVF_None',
    'SAFT11kHz16BitMono', 'DISPID_SRDisplayUI',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'STSF_FlagCreate',
    'DISPID_SOTCGetDataKey', 'DISPID_SRCVoice',
    'SpeechEngineConfidence', 'DISPID_SGRSRule',
    'ISpeechPhraseProperties', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SGRSAddWordTransition', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpeechTokenKeyFiles', 'SAFTDefault', 'ISpeechVoiceStatus',
    'SWPUnknownWordUnpronounceable', 'SpeechDictationTopicSpelling',
    'DISPID_SPIGrammarId', 'SpeechTokenShellFolder',
    'DISPID_SpeechPhraseRule', 'DISPID_SOTGetAttribute',
    'ISpeechRecognizerStatus', 'SPAO_NONE',
    'DISPID_SpeechAudioBufferInfo', 'SPRECOGNIZERSTATUS',
    'SpeechTokenValueCLSID', 'SPEI_SR_BOOKMARK', 'SpVoice',
    'SAFTADPCM_11kHzMono', 'SPADAPTATIONRELEVANCE',
    'DISPID_SpeechGrammarRules', 'SPWORD',
    'DISPID_SRSSupportedLanguages', 'DISPID_SFSClose',
    'SPAUDIOBUFFERINFO', 'SAFT11kHz8BitStereo', 'ISpeechVoice',
    'DISPID_SRGCmdLoadFromResource', 'SVEEndInputStream', 'SDTAudio',
    'DISPID_SpeechMemoryStream', 'SPWF_INPUT', 'DISPID_SABufferInfo',
    'DISPIDSPTSI_ActiveOffset', 'SRARoot', 'SPDKL_DefaultLocation',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'eLEXTYPE_MORPHOLOGY',
    'SPEI_SOUND_END', 'SPSNotOverriden', 'SPCS_ENABLED',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SGRSTType',
    'DISPID_SPIElements', 'DISPID_SVSpeakCompleteEvent', 'SLODynamic',
    'SASRun', 'SAFT11kHz8BitMono', 'IInternetSecurityManager',
    'SVP_4', 'SpeechRecoContextState',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISpVoice',
    'SGLexicalNoSpecialChars', 'DISPID_SGRsCommitAndSave',
    'SPWF_SRENGINE', 'DISPID_SPEDisplayAttributes', 'SSTTWildcard',
    'SPPS_LMA', 'SVSFPersistXML'
]

_check_version('1.2.0', 1697038525.314292)
